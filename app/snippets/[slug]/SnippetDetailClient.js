...
const difficultyLabels = {
  beginner: { de: "Einsteiger", en: "Beginner", color: "var(--muted)" },
  intermediate: { de: "Fortgeschritten", en: "Intermediate", color: "var(--muted)" },
  advanced: { de: "Experte", en: "Advanced", color: "var(--muted)" },
};
...
export default function SnippetDetailClient({ snippet }) {
  ...
  const highlights = getText(snippet.highlights, lang);
  const difficulty = difficultyLabels[snippet.difficulty];
            ...
            <section className="mb-12">
              ...
              <div className="flex gap-6 text-sm" style={{ color: "var(--muted)" }}>
                {snippet.stats.linesOfCode && (
                  <span>~{snippet.stats.linesOfCode} {t.lines}</span>
                )}
                {snippet.stats.fileSize && (
                  <span>{snippet.stats.fileSize}</span>
                )}
              </div>
            </section>
          )}
